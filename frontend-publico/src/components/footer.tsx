        ...
        <footer className="bg-card border-t border-border">
            <div className="container mx-auto px-4 py-12">
                    ...
                    <div className="lg:col-span-2">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">Amor, Caridade e Evolução</p>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <span className="text-muted-foreground text-sm">contato@gruposcheilla.org.br</span>
                            </div>
                        </div>

                        <div className="mt-6">
                            <h5 className="font-semibold text-card-foreground mb-2">Horários de Funcionamento</h5>
                            <div className="text-sm text-muted-foreground space-y-1">
                                <p>Seg - Sex: 19h às 21h</p>
                                <p>Sábados: 14h às 17h</p>
                                <p>Domingos: 9h às 12h</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-border mt-8 pt-8 text-center">
                    ...
                    <p className="text-muted-foreground text-xs mt-2">&#34;Fora da caridade não há salvação&#34; - Allan Kardec</p>
                </div>
            </div>
        </footer>
    )
